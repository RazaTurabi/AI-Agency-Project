...
function initRevealElements() {
  ...
  elements.forEach(function (elem) {
    var duration = parseFloat(elem.getAttribute("data-duration") || "0.6");
    var delay = parseFloat(elem.getAttribute("data-delay") || "0");
    var offset = parseFloat(elem.getAttribute("data-offset") || "60");
    var instant = elem.hasAttribute("data-instant") && elem.getAttribute("data-instant") !== "false";
    var start = elem.getAttribute("data-start") || "top 90%";
    var end = elem.getAttribute("data-end") || "top 50%";
    var direction = elem.getAttribute("data-direction") || "down";
    var useSpring = elem.hasAttribute("data-spring");
    var spring = useSpring && Springer ? Springer(0.2, 0.8) : undefined;
    var rotation = parseFloat(elem.getAttribute("data-rotation") || "0");
    var animationType = elem.getAttribute("data-animation-type") || "from";
